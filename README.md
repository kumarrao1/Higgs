...
3. Install VSCode and add extension Codex by using prompts provided in the folder - readme.md
4. Install dependent files (pandoc, textutil etc) as listed in the readme.md
5. Open VS Code and open the FIRSTDRAFT workspace.
6. Converse with Codex (ChatGPT window in VS Code) - 'Create first draft'   or 'Review the <doc> in Source folder'
